                        ...
                        <div class="col mt-10 mb-10">
                            ...
                            <div class="header-top-right">
                                <?php if (isset($_SESSION['user'])) { ?>
                                   ...
                                   <p> <a href="?act=account"><img class="rounded-circle shadow-1-strong"
                                        src="./public/uploads/<?=$_SESSION['user']['image_tk']?>" alt="avatar: "
                                        width="40" height="40" />
                        ...
                        <div class="col order-2 order-lg-3">
                            ...
                            <div class="header-shop-links">
                                ...
                                <div class="header-search">
                                    <button class="search-toggle"><img src="public/assets/images/icons/search.png"
                                            alt="Search Toggle"><img class="toggle-close"
                                            src="public/assets/images/icons/close.png" alt="Search Toggle"></button>
                                    <div class="header-search-wrap">
                                        <form action="?act=shop&nd=danhmuc" method="post">
                                            <input type="text" placeholder="Type and hit enter" name="kyw">
                                            <button type="submit"><img src="public/assets/images/icons/search.png"
                                                    alt="Search"></button>
                                        </form>
                                    </div>
                                </div>

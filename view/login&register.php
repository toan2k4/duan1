            ...
            <div class="col-lg-4 col-12 mb-40">
                <div class="login-register-form-wrap">
                    ...
                    <form action="?act=login&nd=login" class="mb-30" method="post">
                        <div class="row">
                            <div class="col-12 mb-15"><input type="email" placeholder="Email" name="email" required></div>
                            <div class="col-12 mb-15"><input type="password" placeholder="Password" name="pass" required></div>

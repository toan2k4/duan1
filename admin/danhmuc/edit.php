<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <form action="?act=danhmuc&nd=update" enctype="multipart/form-data" method="post">
                <div class="mb-3 mt-3">
                    <label for="email" class="form-label">Id:</label>
                    <input class="form-control" placeholder="AUTO NUMBER" readonly>
                    <input type="hidden" name="id" class="form-control" value="<?= $dm['id_dm'] ?>">
                </div>
                <div class="mb-3">
                    <label for="pwd" class="form-label">Name:</label>
                    <input type="text" class="form-control" id="pwd" placeholder="Tên Danh Mục" name="name" value="<?= $dm['name_dm'] ?>" required>
                </div>
